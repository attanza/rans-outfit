      ...
      <v-card light>
        ...
        <v-container fluid style="padding-top: 0; padding-bottom: 0;" grid-list-md>
          ...
          <v-layout v-if="radios == '2'" row wrap>
            ...
            <v-flex sm6 xs12>
              <label>Limit</label>
              <v-text-field v-model="queryData.limit" name="limit" type="number"/>
            </v-flex>
            <v-flex sm6 xs12>
            ...
            <v-flex v-if="queryData.range_by != ''" sm6 xs12>
              ...
              >
                ...
                <v-date-picker
                  v-model="queryData.range_start"
                  @input="$refs.menu_range_start.save(queryData.range_start)"
                />
              </v-menu>
            </v-flex>
            <v-flex v-if="queryData.range_by != ''" sm6 xs12>
              ...
              >
                ...
                <v-date-picker
                  v-model="queryData.range_end"
                  @input="$refs.menu_range_end.save(queryData.range_end)"
                />
              </v-menu>
            </v-flex>
          </v-layout>
