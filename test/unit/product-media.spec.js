...
const { test, trait, before } = use("Test/Suite")("Product Media");
...
//   let attributes = await ProductMedia.query()
...
//   const data = await ProductMedia.create(postData);
//   const response = await client
...
//   let data = await ProductMedia.create(postData);
//   const response = await client
...
//     }
//   });
//   let newData = await ProductMedia.find(data.id);
...
//   const product = await ProductMedia.create(postData);
//   const response = await client
